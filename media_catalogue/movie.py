...
class MediaCatalogue:
    ...
    def __str__(self):
        ...
        if movies:
            result += '=== MOVIES ===\n'
            # Indented for loop using movies instead of self.items
...
from movie import Movie, TVSeries, MediaCatalogue, MediaError

catalogue = MediaCatalogue()

try:
    # Adding movies and series to the catalogue
